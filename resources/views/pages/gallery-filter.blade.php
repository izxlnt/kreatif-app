        ...
        <section class="gallery-one">
            <div class="container-fluid">
                ...
                <div class="row masonry-layout filter-layout">
                    <div class="col-md-6 col-lg-3 filter-item design">
                    ...
                    <div class="col-md-6 col-lg-3 filter-item photography">
                        <div class="gallery-one__card">
                    ...
                    <div class="col-md-6 col-lg-3 filter-item branding">
                        <div class="gallery-one__card">
                    ...
                    <div class="col-md-6 col-lg-3 filter-item branding photography">
                        <div class="gallery-one__card">
                    ...
                    <div class="col-md-6 col-lg-3 filter-item development">
                        <div class="gallery-one__card">
                    ...
                    <div class="col-md-6 col-lg-6 filter-item photography">
                        <div class="gallery-one__card">
