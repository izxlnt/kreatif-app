                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <div class="about-three__content__skill">
                                    <h5 class="about-three__content__skill__title">{{ __('common.about_why_choose_us') }}
                                    </h5>
                                    <p class="about-three__content__skill__text">
                                        <b>{{ __('common.about_experienced_title') }}</b>
                                        {{ __('common.about_experienced_text') }}</p>
                                    <p class="about-three__content__skill__text">
                                        <b>{{ __('common.about_high_quality_title') }}</b>
                                        {{ __('common.about_high_quality_text') }}</p>
                                    <p class="about-three__content__skill__text">
                                        <b>{{ __('common.about_consistent_title') }}</b>
                                        {{ __('common.about_consistent_text') }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="about-three__content__author">
                                    <p class="about-three__content__author__text">{{ __('common.about_company_tagline') }}
                                    </p>
                                </div>
                            </div>
                        </div>
