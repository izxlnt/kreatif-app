...
@section('title', 'Products Right Sidebar || Tolak || Tolak Laravel Template')
@php
    $title = 'Products';
    $subtitle = 'Products';
@endphp
                ...
                <div class="row ">
                    <div class="col-lg-9">
                        ...
                        <div class="row gutter-y-30">
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="product__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='800ms'>
                                    <div class="product__item__img">
                                        <img src="{{ asset("/assets/images/products/product-1-9.jpg") }}" alt="tolak">
                                        <div class="product__item__btn">
                                            <a href="{{ url("cart") }}"><i class="far fa-heart"></i></a>
                                            <a href="{{ url("product-details") }}"><i class="fas fa-eye"></i></a>
                                        </div>
                                    ...
                                    <div class="product__item__content">
                                        ...
                                        <h4 class="product__item__title"><a href="{{ url("product-details") }}">Long Chair</a></h4><!-- /.product-title -->
                                        <div class="product__item__price">$86.00</div><!-- /.product-price -->
                                        <a href="{{ url("cart") }}" class="tolak-btn product__item__link"><b>Add to Cart</b><span></span></a>
                                    </div><!-- /.product-content -->
                                </div><!-- /.product-item -->
                            </div><!-- /.col-md-6 col-lg-4 -->
                        ...
                        <div class="product__sidebar product__sidebar-right">
                            ...
                            <div class="product__categories">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="{{ url("products") }}"><span class="fa fa-arrow-right"></span>Web Development</a></li>
                                    <li><a href="{{ url("products") }}"><span class="fa fa-arrow-right"></span>Social Marketing</a></li>
                                    <li><a href="{{ url("products") }}"><span class="fa fa-arrow-right"></span>Technology</a></li>
                                    <li><a href="{{ url("products") }}"><span class="fa fa-arrow-right"></span>Digital Solutions</a></li>
                                    <li><a href="{{ url("products") }}"><span class="fa fa-arrow-right"></span>Business &amp; Finance</a></li>
                                </ul>
                            </div><!-- /.category-widget -->
                        </div><!-- /.shop-sidebar -->
                    </div><!-- /.col-lg-3 -->
