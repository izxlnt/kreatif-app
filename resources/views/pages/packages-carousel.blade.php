...
@section('title', 'Pricing Carousel || Tolak || Tolak Laravel Template')
@php
...
<x-strickyHeader/>
        ...
        <section class="pricing-one">
            <div class="container">
                ...
                <div class="pricing-one__carousel tolak-owl__carousel tolak-owl__carousel--basic-nav owl-carousel owl-theme" data-owl-options='{
            "items": 1,
            "margin": 30,
            "loop": false,
            "smartSpeed": 700,
