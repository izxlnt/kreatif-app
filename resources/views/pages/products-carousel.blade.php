...
@section('title', 'Products Carousel || Tolak || Tolak Laravel Template')
@php
...
<x-strickyHeader/>
        ...
        <section class="product-one">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="product-one__carousel tolak-owl__carousel tolak-owl__carousel--with-shadow tolak-owl__carousel--basic-nav owl-carousel owl-theme" data-owl-options='{
            "items": 1,
            "margin": 0,
            "loop": false,
            "smartSpeed": 700,
