...
@section('title', 'Home RTL || Tolak || Tolak Laravel Template For It Solution & Business')
@php
    $css = '<link rel="stylesheet" href="' . asset('assets/css/tolak-custom-rtl.css') . '"/> 
            <link rel="stylesheet" href="' . asset('assets/vendors/tolak-toolbar/css/tolak-toolbar.css') . '"/>
            <link rel="stylesheet" href="' . asset('assets/css/tolak-rtl.css') . '"/>';
@endphp
@section('content')
