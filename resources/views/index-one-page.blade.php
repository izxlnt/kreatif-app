        ...
        <div class="item">
            <div class="main-slider-one__item">
                <div class="main-slider-one__shape tolak-tilt" data-tilt-options='{ "glare": false, "maxGlare": 0, "maxTilt": 7, "speed": 700, "scale": 1 }'>
                    <img src="{{ asset("/assets/images/shapes/slider-1-shape-1.png") }}" alt="tolak">
                </div>
            ...
            <div class="col-xl-6 wow fadeInLeft" data-wow-delay="300ms">
                <div class="about-one__content">
                    ...
                    <div class="about-one__content__btn">
                        ...
                        <img class="about-one__content__btn__arrow" src="{{ asset("/assets/images/shapes/arrow.png") }}" alt="tolak">
                    </div>
            ...
            <div class="col-xl-6">
                <div class="tolak-stretch-element-inside-column">
                    <div class="about-one__image wow slideInRight">
                        <img src="{{ asset("/assets/images/resources/about-1-1.jpg") }}" alt="tolak">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="funfact-one__image">
                    ...
                    <img class="funfact-one__image__shape" src="{{ asset("/assets/images/shapes/counter-border-1.png") }}" alt="tolak">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="our-solution__image">
                    ...
                    <img src="{{ asset("/assets/images/resources/solution-1-1.png") }}" alt="tolak">
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="contact-one__info wow fadeInLeft" data-wow-delay="100ms">
                    ...
                    <p class="contact-one__info__text"><a href="{{ url("tel:255225551") }}">++255225551</a>, <a href="{{ url("tel:6544144444") }}">+6544144444</a></p>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="contact-one__image wow fadeInRight" data-wow-delay="200ms">
                    <img src="{{ asset("/assets/images/resources/contact-1-1.png") }}" alt="tolak">
                </div>
            </div>
        </div>
    </div><!-- /.container -->
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="contact-one__image-two">
                        <img src="{{ asset("/assets/images/resources/contact-1-2.jpg") }}" alt="tolak">
                    </div>
                </div>
                <div class="col-lg-6">
