...
<header class="main-header-two sticky-header sticky-header--one-page">
    <div class="container">
        <div class="main-header-two__inner">
            ...
            <nav class="main-header-two__nav main-menu">
                <ul class="main-menu__list one-page-scroll-menu">
                    ...
                    <li class="scrollToLink"><a href="{{ url("#services") }}">Services</a></li>
                    <li class="scrollToLink"><a href="{{ url("#project") }}">Project</a></li>
                    <li class="scrollToLink"><a href="{{ url("#testimonial") }}">Testimonials</a></li>
